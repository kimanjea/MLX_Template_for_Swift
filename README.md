...
Download Data Activism Classifier: https://drive.google.com/drive/folders/1EpnH9JVzCzHVDFcGRVxk39E0YJVEGmeB?usp=sharing
...
export OPENAI_API_KEY=## {replace with actual tokens before running}
...
## NB:
Make sure to delete Mistral.safetensors from the folder before you run the app for a conversation
...
* Write unit tests for the classifier and retrieval in.
